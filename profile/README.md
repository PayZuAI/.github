...
**No claude.ai ou Claude Desktop** (mais fácil): Configurações → Conectores → *Adicionar conector personalizado* → cole a URL abaixo. Uma página da PayZu abre pedindo autorização. Pronto.
